...
addRepeat('verse');
    ...
    createButton("B_", "B",  "X", 14, 13, 11, 12, 11, "verse");
repeatEnd('verse', 3);
...
addRepeat('chorus');
    ...
    createButton("Dbmb6", "C#m(b6)", "X", 4, 2, 2, 2, "X", "chorus");
...
addRepeat('bridge');
    ...
    createButton("E_____", "E", 0, 7, 9, 9, 8, 7, "bridge");
